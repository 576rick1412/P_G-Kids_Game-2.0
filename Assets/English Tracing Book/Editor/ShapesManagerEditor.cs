...
public class ShapesManagerEditor : Editor
{
    ...
    private void ShowAttributesSection(ShapesManager shapesManager)
    {
        ...
        shapesManager.AlbumShapeLineWidth = EditorGUILayout.Slider("Album Shape Line Width", shapesManager.AlbumShapeLineWidth, 0.01f, 10);
        shapesManager.AlbumCompoundShapeLineWidth = EditorGUILayout.Slider("Album CompoundShapeLine Width", shapesManager.AlbumCompoundShapeLineWidth, 0.01f, 10);
        EditorGUILayout.Separator();
        shapesManager.GameShapeLineWidth = EditorGUILayout.Slider("Game Shape Line Width", shapesManager.GameShapeLineWidth, 0.01f, 10);
        shapesManager.GameCompoundShapeLineWidth = EditorGUILayout.Slider("Game CompoundShape Line Width", shapesManager.GameCompoundShapeLineWidth, 0.01f, 10);
